...
/// Parameters for updating performance metrics
...
impl RiskMetricsCollector {
    ...
    pub fn update_performance_metrics(&self, metrics: PerformanceMetricsUpdate) {
...
mod tests {
    ...
    fn test_performance_metrics_update() {
        ...
        metrics.update_performance_metrics(PerformanceMetricsUpdate {
            total: 10,
            wins: 6,
            losses: 4,
            win_rate: 0.6,
